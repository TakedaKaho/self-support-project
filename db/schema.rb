...
ActiveRecord::Schema.define(version: 2024_08_27_081330) do
  ...
  create_table "body_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_body_logs_on_user_id"
  end
  ...
  create_table "fights", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["tweet_id"], name: "index_fights_on_tweet_id"
  ...
  add_foreign_key "body_logs", "users"
  add_foreign_key "exercise_logs", "users"
  add_foreign_key "fights", "tweets"
